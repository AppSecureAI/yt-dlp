...
class AENetworksBaseIE(ThePlatformIE):  # XXX: Do not subclass from concrete IE
    ...
    _DOMAIN_MAP = {
        'history.com': ('HISTORY', 'history', os.environ.get('AENETWORKS_HISTORY_SOFTWARE_STATEMENT')),
        'aetv.com': ('AETV', 'aetv', os.environ.get('AENETWORKS_AETV_SOFTWARE_STATEMENT')),
        'mylifetime.com': ('LIFETIME', 'lifetime', os.environ.get('AENETWORKS_LIFETIME_SOFTWARE_STATEMENT')),
        'fyi.tv': ('FYI', 'fyi', os.environ.get('AENETWORKS_FYI_SOFTWARE_STATEMENT')),
