...
class AENetworksBaseIE(ThePlatformIE):  # XXX: Do not subclass from concrete IE
    ...
    _DOMAIN_MAP = {
        'history.com': ('HISTORY', 'history', os.environ.get('AEN_SOFTWARE_STATEMENT_HISTORY')),
        'aetv.com': ('AETV', 'aetv', os.environ.get('AEN_SOFTWARE_STATEMENT_AETV')),
        'mylifetime.com': ('LIFETIME', 'lifetime', os.environ.get('AEN_SOFTWARE_STATEMENT_LIFETIME')),
        'fyi.tv': ('FYI', 'fyi', os.environ.get('AEN_SOFTWARE_STATEMENT_FYI')),
