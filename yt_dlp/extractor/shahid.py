...
class ShahidBaseIE(AWSIE):
    ...
    _AWS_API_KEY = os.environ.get('SHAHID_AWS_API_KEY')
    _AWS_ACCESS_KEY_ID = os.environ.get('SHAHID_AWS_ACCESS_KEY_ID')
    _AWS_SECRET_ACCESS_KEY = os.environ.get('SHAHID_AWS_SECRET_ACCESS_KEY')
